...
const styles = StyleSheet.create({ container: { alignItems: "center", backgroundColor: colors.surface, borderRadius: 19, bottom: 76, elevation: 10, flexDirection: "row", left: 10, padding: 11, position: "absolute", right: 10, shadowColor: "#000", shadowOpacity: 0.2, shadowRadius: 12, zIndex: 50 }, copy: { alignItems: "center", flex: 1, flexDirection: "row", marginRight: 5 }, iconWrap: { alignItems: "center", backgroundColor: colors.soft, borderRadius: 16, height: 34, justifyContent: "center", width: 34 }, copyText: { flex: 1, marginLeft: 10 }, title: { color: colors.text, fontSize: 12, fontWeight: "800" }, subtitle: { color: colors.muted, fontSize: 10, marginTop: 4 }, control: { alignItems: "center", height: 36, justifyContent: "center", width: 34 }, play: { alignItems: "center", backgroundColor: colors.accent, borderRadius: 18, height: 36, justifyContent: "center", width: 36 }, close: { alignItems: "center", height: 34, justifyContent: "center", marginLeft: 2, width: 28 }, disabled: { opacity: 0.3 }, pressed: { opacity: 0.72, transform: [{ scale: 0.95 }] } });
